...
class AHRSfusion:   
    ...
    def __init__(self, gyro_range, sample_rate):        
        ...
        self.ahrs.settings = imufusion.Settings(
                                                ...
                                                8.5,  # 0.5 gain (on the accel error correction)
    ...
    def update(self, gyro_data, accel_data, mag_data = None, delta_time=.001):
        ...
        internal_states = np.array([self.ahrs.internal_states.acceleration_error,
        ...
        flags = np.array([self.ahrs.flags.initialising,
